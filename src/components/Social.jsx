...
function Social() {
  ...
  return (
    <div
      className={`fixed z-50 space-y-3 transition-transform left-0 ease-in-out duration-1000 border-y border-r border-neutral-500 ${
        load ? "-translate-x-full" : "translate-x-0"
      } top-32 p-2 rounded-r-md bg-neutral-800`}
    >
      <div>
        <a
          href="https://twitter.com/AnukulSaxe2566"
      ...
      <div>
        <a
          href="https://github.com/AnukulSaxena"
      ...
      <div>
        <a
          href="https://leetcode.com/copopoco71/"
          className="text-gray-500  hover:text-white "
        >
          <svg
            className={svgClassname}
      ...
      <div>
        <a
          href="https://www.linkedin.com/in/anukul-prakash-saxena/"
          className="text-gray-500 hover:text-white "
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
