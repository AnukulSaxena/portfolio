...
function ProjectSection() {
  ...
  return (
    <div className="mx-5 mt-5 sm:h-[26rem] h-[44rem] rounded-md overflow-hidden">
      <section
        className={`
    ${load ? "translate-y-0" : "translate-y-full"}
     bg-neutral-800 rounded-md sm:px-10 relative transition-transform ease-in-out delay-[1500ms] scroll-smooth duration-1000`}
      >
        <div
